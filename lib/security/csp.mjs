...
export function generateCSPHeader() {
  const cspDirectives = [
    "default-src 'self'",
    "script-src 'self' 'unsafe-eval' 'unsafe-inline' 'wasm-unsafe-eval' https://va.vercel-scripts.com https://js.hcaptcha.com https://js.stripe.com", // Next.js, Vercel Analytics, HCaptcha, Stripe, WASM
