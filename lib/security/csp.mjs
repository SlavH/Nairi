...
export function generateCSPHeader() {
  const cspDirectives = [
    ...
    "font-src 'self' data:",
    "connect-src 'self' https://api.openai.com https://api.anthropic.com https://generativelanguage.googleapis.com https://api.groq.com https://api.cohere.ai https://api.mistral.ai https://api.perplexity.ai https://openrouter.ai https://api.replicate.com https://api.together.xyz https://*.supabase.co wss://*.supabase.co https://vitals.vercel-insights.com https://hcaptcha.com https://*.hcaptcha.com https://api.stripe.com", // AI providers, Supabase, Vercel Analytics, HCaptcha, Stripe
...
export function generateDevCSPHeader() {
  const cspDirectives = [
    ...
    "font-src 'self' data:",
    "connect-src 'self' ws://localhost:* http://localhost:* https://api.openai.com https://api.anthropic.com https://generativelanguage.googleapis.com https://api.groq.com https://api.cohere.ai https://api.mistral.ai https://api.perplexity.ai https://openrouter.ai https://api.replicate.com https://api.together.xyz https://*.supabase.co wss://*.supabase.co https://vitals.vercel-insights.com https://hcaptcha.com https://*.hcaptcha.com https://api.stripe.com",
    "frame-src 'self' blob: https://*.codesandbox.io https://*.sandpack.codesandbox.io https://*.hcaptcha.com https://hcaptcha.com https://js.stripe.com https://hooks.stripe.com",
    "frame-ancestors 'self'",
    "base-uri 'self'",
    "form-action 'self'",
