...
function ScrollBar({
  ...
  return (
    <ScrollAreaPrimitive.ScrollAreaScrollbar
      ...
      className={cn(
        'flex touch-none p-0.5 transition-all select-none bg-zinc-200/30 dark:bg-zinc-800/50',
        orientation === 'vertical' &&
    ...
    >
      <ScrollAreaPrimitive.ScrollAreaThumb
        ...
        className="bg-zinc-400 hover:bg-zinc-500 dark:bg-zinc-500 dark:hover:bg-zinc-400 relative flex-1 rounded-full transition-colors min-h-[40px]"
      />
    </ScrollAreaPrimitive.ScrollAreaScrollbar>
  )
}
